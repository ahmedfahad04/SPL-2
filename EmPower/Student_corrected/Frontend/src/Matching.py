...
class Matching_Window(QWidget):
    ...
    def load_matching_images(self):
        ...
        with open(self.matching_folder + "/image_data.json", "r") as json_file:
            ...
            # fill the image tags
            self.image_tags = [value for key, value in self.image_tag_dict.items() if "creation" not in key]
            print("LABEL_1: ", self.image_tags)
        ...
        print("IMG1: ", self.images[0])
        print("LABEL_2: ", self.image_tags)
       

        # change the aspect ration so that it fit any kind of label
